...
// add command baseline2
static cl::opt<bool> BASELINE2("baseline2",
	cl::desc("Enable BASELINE2 (w/o optimization)"),
	cl::init(false));
//
namespace {
...
static int compileModule(char **argv, LLVMContext &Context) {
  ...
  //add -baseline2 command
  Options.MCOptions.BASELINE2 = BASELINE2;
  // 
